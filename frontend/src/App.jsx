      ...
      <div className="min-h-screen bg-gray-50 dark:bg-[#0b0f19] text-gray-900 dark:text-slate-100 font-sans selection:bg-indigo-100 selection:text-indigo-900 flex flex-col transition-colors duration-300">
        ...
        <main className="flex-1 w-full relative">
          <Routes>
            ...
            <Route path="/elections/:address/proposals/new" element={
              <ProtectedRoute requiredRoles={['admin', 'superadmin']}>
                <CreateProposal />
              </ProtectedRoute>
            } />
            <Route path="/elections/:address/proposals/:proposalId/vote" element={<ElectionVote />} />
            <Route path="/elections/:address/proposals/:proposalId/results" element={<ProposalResults />} />
            ...
            <Route path="*" element={
              <div className="text-center py-20">
                ...
                <Link to="/" className="px-6 py-2.5 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-colors">
                  Go Home
                </Link>
              </div>
            } />
